...
class XliffFileLoader implements LoaderInterface
{
    ...
    public function load($respource, $locale, $domain = 'messages')
    {
        ...
        $this->extract($respource, $catalogue, $domain);
    ...
    private function extract($respource, MessageCatalogue $catalogue, $domain)
    {
        try {
            $dom = XmlUtils::loadFile($respource);
        } catch (\InvalidArgumentException $e) {
            throw new InvalidResourceException(sprintf('Unable to load "%s": %s', $respource, $e->getMessage()), $e->getCode(), $e);
        }
