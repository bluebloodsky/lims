...
class TranslatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFallbackCatalogueResources()
    {
        ...
        $respources = $translator->getCatalogue('en')->getResources();
        $this->assertCount(1, $respources);
        $this->assertContains( __DIR__.DIRECTORY_SEPARATOR.'fixtures'.DIRECTORY_SEPARATOR.'resources.yml', $respources);

        $respources = $translator->getCatalogue('en_GB')->getResources();
        $this->assertCount(2, $respources);
        $this->assertContains( __DIR__.DIRECTORY_SEPARATOR.'fixtures'.DIRECTORY_SEPARATOR.'empty.yml', $respources);
        $this->assertContains( __DIR__.DIRECTORY_SEPARATOR.'fixtures'.DIRECTORY_SEPARATOR.'resources.yml', $respources);
    }
