...
class XliffFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    public function testLoad()
    {
        ...
        $respource = __DIR__.'/../fixtures/resources.xlf';
    ...
    {
        $loader = new XliffFileLoader();
        $respource = __DIR__.'/../fixtures/non-existing.xlf';
    ...
    {
        $loader = new XliffFileLoader();
        $respource = 'http://example.com/resources.xlf';
        $loader->load($respource, 'en', 'domain1');
    }
    ...
    {
        $loader = new XliffFileLoader();
        $respource = __DIR__.'/../fixtures/resources-2.0.xlf';
        $catalogue = $loader->load($respource, 'en', 'domain1');
