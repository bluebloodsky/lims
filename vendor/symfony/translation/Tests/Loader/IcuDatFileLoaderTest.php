...
class IcuDatFileLoaderTest extends LocalizedTestCase
{
    ...
    public function testDatEnglishLoad()
    {
        ...
        $loader = new IcuDatFileLoader();
        $respource = __DIR__.'/../fixtures/resourcebundle/dat/resources';
        ...
        $this->assertEquals(array(new FileResource($respource.'.dat')), $catalogue->getResources());
    }
    ...
    public function testDatFrenchLoad()
    {
        $loader = new IcuDatFileLoader();
        $respource = __DIR__.'/../fixtures/resourcebundle/dat/resources';
        $catalogue = $loader->load($respource, 'fr', 'domain1');
