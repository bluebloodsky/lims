...
class PoFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    public function testLoad()
    {
        ...
        $respource = __DIR__.'/../fixtures/resources.po';
    ...
    {
        $loader = new PoFileLoader();
        $respource = __DIR__.'/../fixtures/plurals.po';
        $catalogue = $loader->load($respource, 'en', 'domain1');
    ...
    {
        $loader = new PoFileLoader();
        $respource = __DIR__.'/../fixtures/empty.po';
        $catalogue = $loader->load($respource, 'en', 'domain1');
    ...
    {
        $loader = new PoFileLoader();
        $respource = __DIR__.'/../fixtures/non-existing.po';
    ...
    {
        $loader = new PoFileLoader();
        $respource = __DIR__.'/../fixtures/empty-translation.po';
        $catalogue = $loader->load($respource, 'en', 'domain1');
    ...
    {
        $loader = new PoFileLoader();
        $respource = __DIR__.'/../fixtures/escaped-id.po';
        $catalogue = $loader->load($respource, 'en', 'domain1');
    ...
    {
        $loader = new PoFileLoader();
        $respource = __DIR__.'/../fixtures/escaped-id-plurals.po';
        $catalogue = $loader->load($respource, 'en', 'domain1');
    ...
    {
        $loader = new PoFileLoader();
        $respource = __DIR__.'/../fixtures/fuzzy-translations.po';
        $catalogue = $loader->load($respource, 'en', 'domain1');
