...
class MoFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    public function testLoad()
    {
        ...
        $respource = __DIR__.'/../fixtures/resources.mo';
    ...
    {
        $loader = new MoFileLoader();
        $respource = __DIR__.'/../fixtures/plurals.mo';
        $catalogue = $loader->load($respource, 'en', 'domain1');
    ...
    {
        $loader = new MoFileLoader();
        $respource = __DIR__.'/../fixtures/non-existing.mo';
    ...
    {
        $loader = new MoFileLoader();
        $respource = __DIR__.'/../fixtures/empty.mo';
        $loader->load($respource, 'en', 'domain1');
    }
    ...
    {
        $loader = new MoFileLoader();
        $respource = __DIR__.'/../fixtures/empty-translation.mo';
        $catalogue = $loader->load($respource, 'en', 'message');
