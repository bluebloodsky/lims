...
class JsonFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    public function testLoad()
    {
        ...
        $respource = __DIR__.'/../fixtures/resources.json';
    ...
    {
        $loader = new JsonFileLoader();
        $respource = __DIR__.'/../fixtures/empty.json';
        $catalogue = $loader->load($respource, 'en', 'domain1');
    ...
    {
        $loader = new JsonFileLoader();
        $respource = __DIR__.'/../fixtures/non-existing.json';
    ...
    {
        $loader = new JsonFileLoader();
        $respource = __DIR__.'/../fixtures/malformed.json';
        $loader->load($respource, 'en', 'domain1');
    }
}
