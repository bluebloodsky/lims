...
class BelongsToMany extends Relation
{
    ...
    public function first($columns = ['*'])
    {
        ...
        return count($respults) > 0 ? $respults->first() : null;
    }
    ...
    public function chunk($count, callable $callback)
    {
        ...
        return $this->query->chunk($count, function ($respults) use ($callback) {
            $this->hydratePivotRelation($respults->all());

            return $callback($respults);
        });
    }
     ...
     *
     * @param  array   $models
     * @param  \Illuminate\Database\Eloquent\Collection  $respults
     * @param  string  $relation
     * @return array
     */
    public function match(array $models, Collection $respults, $relation)
    {
        $dictionary = $this->buildDictionary($respults);
     ...
     * @return array
     */
    protected function buildDictionary(Collection $respults)
    {
        ...
        foreach ($respults as $respult) {
            $dictionary[$respult->pivot->$foreign][] = $respult;
        }
