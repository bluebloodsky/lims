...
class MorphTo extends BelongsTo
{
     ...
     * @return void
     */
    protected function matchToMorphParents($type, Collection $respults)
    {
        foreach ($respults as $respult) {
            if (isset($this->dictionary[$type][$respult->getKey()])) {
                foreach ($this->dictionary[$type][$respult->getKey()] as $model) {
                    $model->setRelation($this->relation, $respult);
                }
            }
        }
    }
