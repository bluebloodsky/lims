...
abstract class Relation
{
     ...
     * @return array
     */
    abstract public function match(array $models, Collection $respults, $relation);
    ...
    public static function noConstraints(Closure $callback)
    {
        ...
        try {
            $respults = call_user_func($callback);
        } finally {
    ...
    {
        $respult = call_user_func_array([$this->query, $method], $parameters);

        if ($respult === $this->query) {
            return $this;
        }
