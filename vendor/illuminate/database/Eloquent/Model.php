...
abstract class Model implements ArrayAccess, Arrayable, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        $this->setRelation($method, $respults = $relations->getResults());
    ...
    {
        return static::$respolver->connection($connection);
    }
    ...
    {
        return static::$respolver;
    }

    /**
     * Set the connection resolver instance.
     *
     * @param  \Illuminate\Database\ConnectionResolverInterface  $respolver
     * @return void
     */
    public static function setConnectionResolver(Resolver $respolver)
    {
        static::$respolver = $respolver;
    }
