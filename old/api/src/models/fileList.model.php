...
class FileListModel
{
    static public function GetFileList()
    {
        ...
        $RET['toolFiles']=self::GetToolFileList();
		$RET['helpFiles']=self::GetHelpFileList();
        return $RET;
    }
    ...
    static public function GetToolFileList()
    {
        global $gMmsToolHome;
        global $gMmsHome;
        chdir($gMmsHome);
        return self::GetFilesPrivate("tool", "*", $gMmsToolHome);
    }

    static public function GetHelpFileList()
    {
        global $gMmsHelpHome;
        global $gMmsHome;
        chdir($gMmsHome);
        return self::GetFilesPrivate("help", "*", $gMmsHelpHome);
    }
    ...
    {
        global $gMmsHome, $gMmsEtcHome, $gMmsIcdHome,$gMmsToolHome,$gMmsHelpHome;
